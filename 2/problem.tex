...
This can lead to a problem when interchanging a similar TET with another. It is especially problematic for closed-source TETs that create a vendor lock-in effect using this practice. \todo{add example technology where this occurs}
